...
public class StoreConverter {
    ...
    public static StoreResponseDTO.MyReviewPreViewListDTO myReviewPreViewListDTO(Page<Review> myReviewList){
        ...
        String storeName = myReviewList.isEmpty() ? null : myReviewList.toList().get(0).getStore().getName();
    ...
    public static StoreResponseDTO.StoreMissionListDTO storeMissionListDTO(Page<Mission> missionList){
        ...
        String storeName = missionList.isEmpty() ? null : missionList.toList().get(0).getStore().getName();
